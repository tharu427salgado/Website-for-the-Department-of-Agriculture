...
<a style="font-size:20px;float:right;color:white;margin:-4.7% 29.7%;font-family:Arial Rounded MT;text-decoration: none;" href="staff.php?eid=<?php echo $eid?>">Profile</a>
<a style="font-size:20px;float:right;color:white;margin:-4.7% 23.5%;font-family:Arial Rounded MT;text-decoration: none;" href="map.php?eid=<?php echo $eid?>">Map</a>
<a style="font-size:20px;float:right;color:white;margin:-4.7% 13.5%;font-family:Arial Rounded MT;text-decoration: none;" href="message.php?eid=<?php echo $eid?>">Message</a>
<a style="font-size:20px;float:right;color:white;margin:-4.7% 5%;font-family:Arial Rounded MT;text-decoration: none;" href="login.php">Logout</a>
	...
	<br>
	<select style="width: 200px;margin:0% 5%;display:none;" class="form-control" name="flag" id="flag" required="required" pattern="[A-Za-z0-9]{1,20}">
	...
	<br>
	<select style="width: 200px;margin:0% 5%;display:none;" class="form-control" name="status" id="status" required="required" pattern="[A-Za-z0-9]{1,20}">
