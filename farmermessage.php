...
$fid=$_GET['fid'];
$inbox = mysqli_query($conn, "select * from message where mfrom='staff' and fid='$fid'  ORDER BY date DESC");
$sent = mysqli_query($conn, "select * from message where mfrom='farmer' and fid='$fid'  ORDER BY date DESC");
...
<body class="w3-theme-|1" style="background-image: url('13.jpg');background-repeat: no-repeat;background-size: cover;">
    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner" style="background-color:rgba(0,0,0,0.6);height:100px">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
          ...
          <div class="site-logo">
            <a href="" class="text-black"><span class="text-primary">FARMER MESSAGING</a>
            </div>
...
<div class="w3-container w3-white">
  ...
  <form action="farmersend.php" method="post" enctype="multipart/form-data">
  <input name="fid" id="fid" class="w3-input w3-border" type="hidden" value="<?php echo $fid; ?>">
...
<div class="w3-container w3-white">
  ...
  <form action="farmerreply.php" method="post">
  <b><p>MESSAGE:</p></b>
  <p id="inboxmessage"></p><br>
  <b><p>Reply:</p></b>
  <input name="fid" id="1fid" class="w3-input w3-border" type="hidden" value="<?php echo $fid; ?>">
  ...
  <button type="submit" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom" name="replyf">Send Reply</button>
  </form>
</div>
</div>
</div>
