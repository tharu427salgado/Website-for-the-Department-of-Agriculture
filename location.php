...
<script src="https://cdn.rawgit.com/openlayers/openlayers.github.io/master/en/v5.3.0/build/ol.js"></script>
 <script src="https://code.jquery.com/jquery-2.2.3.min.js"></script>
  ...
  <body>
    ...
    <div id="map-canvas" style="width: 1000px; height:550px;float:left;"><div id="popup"></div></div>
	<div id="change" style="display:none;float:right;height:550px; width:320px;margin: 0% 2% -10% 0%; background-color:rgba(50,80,255,0.5); border-radius:0.5%;">
	...
	<br>
	<img id="photo" class="img" src="" style="  border-radius:30px;margin:0% 5%; height:auto;max-height:150px; width:240px;">
	<br><br>
      ...
      map.on('click', function(evt) {
        ...
        if (feature) {
          ...
          $(element).popover({
            'placement': 'top',
            'html': true,
            'content':'<p>Name:<code>' + feature.get('name') + '</code><br>' 
			+'Address:<code>' + feature.get('address') + '</code><br>'+
			'TP:<code>' + feature.get('phone') + '</code><br>'+
			'Status:<code>' + feature.get('status') + '</code></p>'
          });
